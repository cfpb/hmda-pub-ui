export const DYNAMIC_DATASET = {
  2018: {
    ...
    lar_spec : 'https://github.com/cfpb/hmda-platform/blob/master/docs/v2/spec/2018_File_Spec_LAR.csv',
    ts_spec : 'https://github.com/cfpb/hmda-platform/blob/master/docs/v2/spec/2018_File_Spec_TS.csv'
  },
  2017: {
